...
import{ LayoutGrid,Atom,Network,Microscope,Settings,MessageSquareText,ChevronLeft} from "lucide-react";
          ...
          <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
            <Link href="/">
              <div className="flex flex-row items-center justify-center space-x-2">
                ...
                <p className="text-xl font-semibold text-white">MediCore</p>
              </div>
            </Link>
